...
public class BubblingListItem{
	...
	public void setBubblingType(int bubblingType){
		this.bubblingType = bubblingType;
	}

	public int getBubblingType(){
		return bubblingType;
	}
	...
	public void setMoodTip(String moodTip){
		this.moodTip = moodTip;
	}
